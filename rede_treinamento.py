...
#Diretorio onde se encontra o glove
GLOVE_DIR = BASE_DIR + r'\glove.6B'
#Diretorio com texto do twitter
TEXT_DATA_DIR = BASE_DIR + r'\emotion'
#Comprimento da Sequencia 
MAX_SEQUENCE_LENGTH = 1000
#Numero maximo de palavras
...
#Cria vetor de palavras (Emddings)
print('Indexing word vectors.')
cont1 = 0
cont2 = 0
#Inicia vetor
embeddings_index = {}
f = open(os.path.join(BASE_DIR, r'glove_s300.txt'), encoding='utf8')
for line in f:
    values = line.split()
    word = values[0]
    try:
...
with open("model3_100_4.json","w") as json_file:
    json_file.write(model_json)
#serializae 
model.save_weights("model3_100_4.h5")
K.clear_session()